 ...
 */
export function assoc<T, U> (
  __: Placeholder,
  val: T,
  obj: U
): <K extends string>(prop: K) => Record<K, T> & U
export function assoc<U, K extends string> (
  prop: K,
  __: Placeholder,
  obj: U
...
export function complement (
  pred: (...args: readonly any[]) => boolean
...
export function composeK<V0, T1, T2> (
  fn1: (x: T1) => T2[],
  fn0: (x0: V0) => T1[]
): (x0: V0) => T2[]
 ...
 */
// tslint:disable:max-line-length
export function composeP<V0, T1> (
 ...
 */
export function composeWith<V0, T> (
  composer: (a: any, res: any) => any,
  fns: ComposeWithFns<V0, T>
): (x0: V0) => T
export function composeWith (
  composer: (a: any, res: any) => any
): <V0, T>(fns: ComposeWithFns<V0, T>) => (x: V0) => T
...
): (list2: readonly T[], list1: readonly T[]) => T[]
export function concat<T> (
  placeholder: Placeholder,
  list2: readonly T[]
): (list1: readonly T[]) => T[]
...
export function flip<
  ...
  P extends _.F.Parameters<F>
> (fn: F): _.F.Curry<(...args: _.T.Merge<[P[1], P[0]], P>) => _.F.Return<F>>
 ...
 */
export function merge<O2 extends object> (
  __: Placeholder,
  b: O2
): <O1 extends object>(a: O1) => Merge<O2, O1, 'flat'>
export function merge (
  __: Placeholder
): <O1 extends object, O2 extends object>(b: O2, a: O1) => Merge<O2, O1, 'flat'>
export function merge<O1 extends object, O2 extends object> (
  a: O1,
  b: O2
): Merge<O2, O1, 'flat'>
export function merge<O1 extends object> (
  a: O1
): <O2 extends object>(b: O2) => Merge<O2, O1, 'flat'>
 ...
 */
export function mergeDeepLeft<O1 extends object, O2 extends object> (
  o1: O1,
  o2: O2
): Merge<O1, O2, 'deep'>
export function mergeDeepLeft<O1 extends object> (
  o1: O1
): <O2 extends object>(o2: O2) => Merge<O1, O2, 'deep'>
 ...
 */
export function mergeDeepRight<O1 extends object, O2 extends object> (
  o1: O1,
  o2: O2
): Merge<O2, O1, 'deep'>
export function mergeDeepRight<O1 extends object> (
  a: O1
): <O2 extends object>(o2: O2) => Merge<O2, O1, 'deep'>
 ...
 */
export function mergeDeepWith<T1, T2> (
  fn: (x: any, z: any) => any,
  a: T1,
  b: T2
): any
 ...
 */
export function mergeLeft<O1 extends object, O2 extends object> (
  a: O1,
  b: O2
): Merge<O1, O2, 'flat'>
export function mergeLeft<O1 extends object> (
  a: O1
): <O2 extends object>(b: O2) => Merge<O1, O2, 'flat'>

/**
 * Create a new object with the own properties of the first object merged with the own properties of the second object.
 * If a key exists in both objects, the value from the second object will be used.
 */
export function mergeRight<O1 extends object, O2 extends object> (
  a: O1,
  b: O2
): Merge<O2, O1, 'flat'>
export function mergeRight<O1 extends object> (
  a: O1
): <O2 extends object>(b: O2) => Merge<O2, O1, 'flat'>
...
export function mergeWithKey<U> (
  fn: (str: string, x: any, z: any) => any,
  a: U
): <V>(b: V) => any
...
export function nAry (
  n: number,
  fn: (...arg: readonly any[]) => any
): (...a: readonly any[]) => any
export function nAry (
  n: number
): (fn: (...arg: readonly any[]) => any) => (...a: readonly any[]) => any
...
export function or<T extends { or?: (...a: readonly any[]) => any }, U> (
  fn1: T,
  val2: U
): T | U
export function or<T extends { or?: (...a: readonly any[]) => any }> (
  fn1: T
): <U>(val2: U) => T | U
 ...
 */
export function pathSatisfies<T, U> (
  pred: (val: T) => boolean,
  path: Path,
  obj: U
): boolean
...
export function pipeK<V0, T1, T2> (
  fn0: (x0: V0) => T1[],
  fn1: (x: T1) => T2[]
): (x0: V0) => T2[]
 ...
 */
// tslint:disable:max-line-length
export function pipeP<V0, T1> (
  fn0: (x0: V0) => Promise<T1>
): (x0: V0) => Promise<T1>
export function pipeP<V0, T1, T2> (
  fn0: (x0: V0) => Promise<T1>,
  fn1: (x: T1) => Promise<T2>
): (x0: V0) => Promise<T2>
 ...
 * With the current typings, all functions must be unary.
 */
export function pipeWith<V0, T> (
  composer: (a: any) => any,
  fns: PipeWithFns<V0, T>
): (x0: V0) => T
export function pipeWith (
  composer: (a: any) => any
): <V0, T>(fns: PipeWithFns<V0, T>) => (x0: V0) => T
 ...
 * filter a list.
 */
export function propEq<K extends string | number, V> (
  name: K,
  val: V,
  obj: Record<K, V>
): boolean
 ...
 * Otherwise returns the provided default value.
 */
export function propOr<T, U> (
  val: T,
  __: Placeholder,
  obj: U
): <V>(p: string) => V
export function propOr<U> (
  __: Placeholder,
  p: string,
  obj: U
): <T, V>(val: T) => V
 ...
 */
export function propSatisfies<T, U> (
  pred: (val: T) => boolean,
  name: string,
  obj: U
): boolean
...
export function propSatisfies<T, U> (
  pred: (val: T) => boolean
): _.F.Curry<(a: string, b: U) => boolean>
...
export function tryCatch<T> (
  tryer: (...args: readonly any[]) => T,
  catcher: (...args: readonly any[]) => T
): (...args: readonly any[]) => T
...
export function unary<T> (
  fn: (a: T, ...args: readonly any[]) => any
): (a: T) => any

/**
 * Returns a function of arity n from a (manually) curried function.
 */
export function uncurryN<T> (
  len: number,
  fn: (a: any) => any
): (...a: readonly any[]) => T
 ...
 */
export function unfold<T, TResult> (
...
export function useWith (
  fn: (...a: readonly any[]) => any,
  transformers: Array<(...a: readonly any[]) => any>
): (...a: readonly any[]) => any
 ...
 */
export function xprod<K, V> (
  as: readonly K[],
  bs: readonly V[]
): Array<KeyValuePair<K, V>>
export function xprod<K> (
  as: readonly K[]
